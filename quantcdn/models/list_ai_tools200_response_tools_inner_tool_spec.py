...
class ListAITools200ResponseToolsInnerToolSpec(BaseModel):
    """
    ListAITools200ResponseToolsInnerToolSpec
    """ # noqa: E501
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    input_schema: Optional[ListAITools200ResponseToolsInnerToolSpecInputSchema] = Field(default=None, alias="inputSchema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputSchema": ListAITools200ResponseToolsInnerToolSpecInputSchema.from_dict(obj["inputSchema"]) if obj.get("inputSchema") is not None else None
        })
        return _obj
