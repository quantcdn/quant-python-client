...
class V2MetricDataPoint(BaseModel):
    """
    V2MetricDataPoint
    """ # noqa: E501
    timestamp: V2MetricDataPointTimestamp
    value: Union[StrictFloat, StrictInt] = Field(description="Metric value at this timestamp")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timestamp": V2MetricDataPointTimestamp.from_dict(obj["timestamp"]) if obj.get("timestamp") is not None else None,
            "value": obj.get("value")
        })
        return _obj
