...
class DeleteVectorDocuments200Response(BaseModel):
    """
    DeleteVectorDocuments200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    collection_id: Optional[StrictStr] = Field(default=None, alias="collectionId")
    deleted_count: Optional[StrictInt] = Field(default=None, alias="deletedCount")
    __properties: ClassVar[List[str]] = ["message", "collectionId", "deletedCount"]
