...
class V2StoreItemsListResponse(BaseModel):
    """
    V2StoreItemsListResponse
    """ # noqa: E501
    data: Optional[List[StrictStr]] = Field(default=None, description="List of item keys")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Cursor for next page of results")
