...
class UpdateGovernanceConfigRequest(BaseModel):
    ...
    """ # noqa: E501
    ai_enabled: StrictBool = Field(alias="aiEnabled")
    model_policy: StrictStr = Field(alias="modelPolicy")
    ...
    @field_validator('mandatory_guardrail_preset')
    def mandatory_guardrail_preset_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
