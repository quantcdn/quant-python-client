...
class KVItemsShow200Response(BaseModel):
    """
    KVItemsShow200Response
    """ # noqa: E501
    key: Optional[StrictStr] = None
    value: Optional[KVItemsShow200ResponseValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": KVItemsShow200ResponseValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
