...
class V1SearchItemsResponse(BaseModel):
    """
    V1SearchItemsResponse
    """ # noqa: E501
    hits: Optional[List[V1SearchHit]] = None
    nb_pages: Optional[StrictInt] = Field(default=None, alias="nbPages")
    __properties: ClassVar[List[str]] = ["hits", "nbPages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [V1SearchHit.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
