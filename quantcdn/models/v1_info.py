...
class V1Info(BaseModel):
    ...
    V1Info
    """ # noqa: E501
    author_user: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["author_user", "author_name", "author_email", "log", "custom_1", "custom_2", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author_user": obj.get("author_user"),
