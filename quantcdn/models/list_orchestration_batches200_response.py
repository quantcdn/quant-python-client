...
class ListOrchestrationBatches200Response(BaseModel):
    """
    ListOrchestrationBatches200Response
    """ # noqa: E501
    batches: Optional[List[ListOrchestrationBatches200ResponseBatchesInner]] = None
    next_cursor: Optional[StrictStr] = Field(default=None, alias="nextCursor")
    __properties: ClassVar[List[str]] = ["batches", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batches": [ListOrchestrationBatches200ResponseBatchesInner.from_dict(_item) for _item in obj["batches"]] if obj.get("batches") is not None else None,
