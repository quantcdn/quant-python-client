...
class OaiChatCompletions200Response(BaseModel):
    """
    ...
    choices: Optional[List[OaiChatCompletions200ResponseChoicesInner]] = None
    usage: Optional[OaiChatCompletions200ResponseUsage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": obj.get("model"),
            "choices": [OaiChatCompletions200ResponseChoicesInner.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
            "usage": OaiChatCompletions200ResponseUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
