...
class ListVectorCollections200ResponseCollectionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "name", "description", "documentCount", "embeddingModel", "createdAt"]
