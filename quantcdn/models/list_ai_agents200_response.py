...
class ListAIAgents200Response(BaseModel):
    """
    ListAIAgents200Response
    """ # noqa: E501
    agents: Optional[List[ListAIAgents200ResponseAgentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [ListAIAgents200ResponseAgentsInner.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None
        })
        return _obj
