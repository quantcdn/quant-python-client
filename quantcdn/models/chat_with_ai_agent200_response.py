...
class ChatWithAIAgent200Response(BaseModel):
    """
    ChatWithAIAgent200Response
    """ # noqa: E501
    session_id: Optional[StrictStr] = Field(default=None, alias="sessionId")
    response: Optional[ChatWithAIAgent200ResponseResponse] = None
    __properties: ClassVar[List[str]] = ["sessionId", "response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": ChatWithAIAgent200ResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
