...
class ListCustomTools200Response(BaseModel):
    """
    ListCustomTools200Response
    """ # noqa: E501
    tools: Optional[List[ListCustomTools200ResponseToolsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tools": [ListCustomTools200ResponseToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
            "count": obj.get("count")
        })
        return _obj
