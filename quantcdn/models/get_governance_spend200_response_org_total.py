...
class GetGovernanceSpend200ResponseOrgTotal(BaseModel):
    """
    GetGovernanceSpend200ResponseOrgTotal
    """ # noqa: E501
    spend_cents: Optional[StrictInt] = Field(default=None, description="Total org spend in US cents", alias="spendCents")
