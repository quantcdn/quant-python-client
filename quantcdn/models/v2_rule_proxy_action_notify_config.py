...
class V2RuleProxyActionNotifyConfig(BaseModel):
    """
    Notification configuration (required when notify is slack)
    """ # noqa: E501
    webhook_url: Optional[StrictStr] = Field(default=None, description="Slack webhook URL")
    __properties: ClassVar[List[str]] = ["webhook_url"]
