...
class ListOrchestrations200Response(BaseModel):
    """
    ListOrchestrations200Response
    """ # noqa: E501
    orchestrations: Optional[List[Dict[str, Any]]] = None
    next_cursor: Optional[StrictStr] = Field(default=None, alias="nextCursor")
    __properties: ClassVar[List[str]] = ["orchestrations", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orchestrations": obj.get("orchestrations"),
