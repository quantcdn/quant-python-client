...
class V1Revision(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["md5", "type", "byte_length", "revision_number", "date_timestamp", "deleted", "deleted_timestamp", "transitions", "info"]
