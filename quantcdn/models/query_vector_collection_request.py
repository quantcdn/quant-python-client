...
class QueryVectorCollectionRequest(BaseModel):
    ...
    count: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = Field(default=5, description="Number of results to return")
    __properties: ClassVar[List[str]] = ["query", "count"]
