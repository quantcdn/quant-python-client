...
class GetGovernanceConfig200ResponseSpendLimits(BaseModel):
    ...
    interface_limits: Optional[Dict[str, GetGovernanceConfig200ResponseSpendLimitsInterfaceLimitsValue]] = Field(default=None, description="Aggregate spend caps per interface label (slack, autonomous, api-gateway, streaming, websocket, durable, orchestration, workflow, embedding, ai-search). Keys are interface labels.", alias="interfaceLimits")
