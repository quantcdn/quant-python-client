...
class BulkSetEnvironmentVariablesRequest(BaseModel):
    """
    BulkSetEnvironmentVariablesRequest
    """ # noqa: E501
    environment: List[BulkSetEnvironmentVariablesRequestEnvironmentInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environment": [BulkSetEnvironmentVariablesRequestEnvironmentInner.from_dict(_item) for _item in obj["environment"]] if obj.get("environment") is not None else None
        })
        return _obj
