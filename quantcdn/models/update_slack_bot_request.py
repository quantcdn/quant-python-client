...
class UpdateSlackBotRequest(BaseModel):
    ...
    """ # noqa: E501
    agent_id: Optional[StrictStr] = Field(default=None, description="Change the backing AI agent", alias="agentId")
    ...
    __properties: ClassVar[List[str]] = ["agentId", "status", "sessionTtlDays", "allowedChannels", "keywordsEnabled", "keywords", "slashCommands"]
