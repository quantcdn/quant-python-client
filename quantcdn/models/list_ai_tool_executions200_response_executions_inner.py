...
class ListAIToolExecutions200ResponseExecutionsInner(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="Execution status: pending, running, complete, or failed")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    completed_at: Optional[datetime] = Field(default=None, alias="completedAt")
    __properties: ClassVar[List[str]] = ["executionId", "toolName", "status", "createdAt", "completedAt"]
