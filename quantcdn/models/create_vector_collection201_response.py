...
class CreateVectorCollection201Response(BaseModel):
    """
    CreateVectorCollection201Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    collection: Optional[CreateVectorCollection201ResponseCollection] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "collection", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collection": CreateVectorCollection201ResponseCollection.from_dict(obj["collection"]) if obj.get("collection") is not None else None,
