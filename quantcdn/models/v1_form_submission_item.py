...
class V1FormSubmissionItem(BaseModel):
    """
    V1FormSubmissionItem
    """ # noqa: E501
    uuid: StrictStr
    country_ip: StrictStr
    spam_score: StrictStr
    data: StrictStr
    file_count: StrictInt
    date_submitted: StrictStr
    __properties: ClassVar[List[str]] = ["uuid", "country_ip", "spam_score", "data", "file_count", "date_submitted"]
