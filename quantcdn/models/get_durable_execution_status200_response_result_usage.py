...
class GetDurableExecutionStatus200ResponseResultUsage(BaseModel):
    """
    ...
    cost_cents: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost of the final synthesis turn in US cents", alias="costCents")
