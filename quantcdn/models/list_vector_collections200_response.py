...
class ListVectorCollections200Response(BaseModel):
    """
    ListVectorCollections200Response
    """ # noqa: E501
    collections: Optional[List[ListVectorCollections200ResponseCollectionsInner]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["collections", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collections": [ListVectorCollections200ResponseCollectionsInner.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
            "count": obj.get("count")
        })
        return _obj
