...
class ListAIModels200Response(BaseModel):
    """
    ListAIModels200Response
    """ # noqa: E501
    count: Optional[StrictInt] = None
    models: Optional[List[ListAIModels200ResponseModelsInner]] = None
    __properties: ClassVar[List[str]] = ["count", "models"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "models": [ListAIModels200ResponseModelsInner.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
