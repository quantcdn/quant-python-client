...
class AiSearchIngestPagesRequestPagesInner(BaseModel):
    """
    ...
    pre_processed: Optional[StrictBool] = Field(default=None, alias="preProcessed")
    summary: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    topics: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["url", "title", "content", "contentType", "fetchedAt", "preProcessed", "summary", "tags", "topics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preProcessed": obj.get("preProcessed"),
