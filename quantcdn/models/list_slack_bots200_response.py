...
class ListSlackBots200Response(BaseModel):
    """
    ListSlackBots200Response
    """ # noqa: E501
    bots: Optional[List[ListSlackBots200ResponseBotsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bots": [ListSlackBots200ResponseBotsInner.from_dict(_item) for _item in obj["bots"]] if obj.get("bots") is not None else None
        })
        return _obj
