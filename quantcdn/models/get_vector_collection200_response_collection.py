...
class GetVectorCollection200ResponseCollection(BaseModel):
    """
    ...
    document_count: Optional[StrictInt] = Field(default=None, alias="documentCount")
    ...
    __properties: ClassVar[List[str]] = ["collectionId", "name", "description", "documentCount", "embeddingModel", "dimensions", "createdAt", "updatedAt"]
