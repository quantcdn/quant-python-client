...
class OaiChatCompletions200ResponseChoicesInner(BaseModel):
    """
    OaiChatCompletions200ResponseChoicesInner
    """ # noqa: E501
    index: Optional[StrictInt] = None
    message: Optional[OaiChatCompletions200ResponseChoicesInnerMessage] = None
    ...
    def finish_reason_validate_enum(cls, value):
        ...
        if value not in set(['stop', 'tool_calls', 'length']):
            raise ValueError("must be one of enum values ('stop', 'tool_calls', 'length')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "message": OaiChatCompletions200ResponseChoicesInnerMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
