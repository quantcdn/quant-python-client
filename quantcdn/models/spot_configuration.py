...
class SpotConfiguration(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "strategy": obj.get("strategy") if obj.get("strategy") is not None else 'spot-only'
        })
        return _obj
