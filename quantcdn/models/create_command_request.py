...
class CreateCommandRequest(BaseModel):
    ...
    """ # noqa: E501
    command: StrictStr
    container_name: Optional[StrictStr] = Field(default=None, description="Target container (defaults to the first container in the task definition)", alias="containerName")
    __properties: ClassVar[List[str]] = ["command", "containerName"]
