...
class GetAgentOverlay200ResponseBase(BaseModel):
    """
    ...
    assigned_skill_ids: Optional[List[StrictStr]] = Field(default=None, alias="assignedSkillIds")
    __properties: ClassVar[List[str]] = ["agentId", "name", "modelId", "allowedTools", "assignedSkillIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignedSkillIds": obj.get("assignedSkillIds")
        })
        return _obj
