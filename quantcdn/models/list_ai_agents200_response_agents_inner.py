...
class ListAIAgents200ResponseAgentsInner(BaseModel):
    """
    ...
    has_overlay: Optional[StrictBool] = Field(default=None, alias="hasOverlay")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["agentId", "name", "description", "group", "modelId", "temperature", "maxTokens", "allowedTools", "assignedSkills", "longContext", "guardrailPreset", "isGlobal", "hasOverlay", "createdAt", "updatedAt"]
