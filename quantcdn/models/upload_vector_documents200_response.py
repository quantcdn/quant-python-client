...
class UploadVectorDocuments200Response(BaseModel):
    """
    UploadVectorDocuments200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    document_ids: Optional[List[StrictStr]] = Field(default=None, alias="documentIds")
    chunks_created: Optional[StrictInt] = Field(default=None, alias="chunksCreated")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "documentIds", "chunksCreated", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chunksCreated": obj.get("chunksCreated"),
