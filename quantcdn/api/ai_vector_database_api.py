...
class AIVectorDatabaseApi:
    ...
    @validate_call
    def delete_vector_documents(
        self,
        organisation: Annotated[StrictStr, Field(description="Organisation machine name")],
        collection_id: Annotated[StrictStr, Field(description="Collection UUID")],
        delete_vector_documents_request: DeleteVectorDocumentsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param organisation: Organisation machine name (required)
        :type organisation: str
        :param collection_id: Collection UUID (required)
        :type collection_id: str
        :param delete_vector_documents_request: (required)
        :type delete_vector_documents_request: DeleteVectorDocumentsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_vector_documents_serialize(
            organisation=organisation,
            collection_id=collection_id,
            delete_vector_documents_request=delete_vector_documents_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteVectorDocuments200Response",
            '400': None,
            '403': None,
            '404': None,
            '500': None,
    ...
    @validate_call
    def delete_vector_documents_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="Organisation machine name")],
        collection_id: Annotated[StrictStr, Field(description="Collection UUID")],
        delete_vector_documents_request: DeleteVectorDocumentsRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteVectorDocuments200Response]:
        """Delete Documents from Collection
    ...
    @validate_call
    def delete_vector_documents_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="Organisation machine name")],
        collection_id: Annotated[StrictStr, Field(description="Collection UUID")],
        delete_vector_documents_request: DeleteVectorDocumentsRequest,
    ...
    def _delete_vector_documents_serialize(
        self,
        organisation,
        collection_id,
        delete_vector_documents_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if delete_vector_documents_request is not None:
            _body_params = delete_vector_documents_request
