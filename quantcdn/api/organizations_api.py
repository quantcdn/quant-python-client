...
class OrganizationsApi:
    ...
    def organizations_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[OrganizationsList200ResponseInner]",
            '400': "V2Error",
            '403': "V2Error",
        }
    ...
    def organizations_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[OrganizationsList200ResponseInner]]:
        """Retrieve all organizations
    ...
    def organizations_read(
        ...
        _param = self._organizations_read_serialize(
    ...
    @validate_call
    def organizations_read_with_http_info(
        self,
        organization: Annotated[StrictStr, Field(description="Organization identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def organizations_read_without_preload_content(
        self,
        organization: Annotated[StrictStr, Field(description="Organization identifier")],
        _request_timeout: Union[
            None,
    ...
    def _organizations_read_serialize(
        self,
        organization,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/organizations/{organization}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
