...
class ApplicationsApi:
    ...
    def create_application(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "Application",
            '400': None,
            '403': "CreateApplication403Response",
        }
    ...
    def _create_application_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/organizations/{organisation}/applications',
    ...
    def _delete_application_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/organizations/{organisation}/applications/{application}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_ecr_login_credentials(
        ...
        _param = self._get_ecr_login_credentials_serialize(
            organisation=organisation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetEcrLoginCredentials200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_ecr_login_credentials_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetEcrLoginCredentials200Response]:
        """Get ECR login credentials
    ...
    @validate_call
    def get_ecr_login_credentials_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_ecr_login_credentials_serialize(
        self,
        organisation,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/applications/ecr-login',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
