...
class SubscriptionApi:
    ...
    @validate_call
    def get_subscription_cloud_usage(
        self,
        ...
        _param = self._get_subscription_cloud_usage_serialize(
    ...
    @validate_call
    def get_subscription_cloud_usage_with_http_info(
        self,
        organisation: StrictStr,
        month: Annotated[Optional[StrictStr], Field(description="YYYY-MM, defaults to current month")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_subscription_cloud_usage_without_preload_content(
        self,
        organisation: StrictStr,
        month: Annotated[Optional[StrictStr], Field(description="YYYY-MM, defaults to current month")] = None,
        _request_timeout: Union[
    ...
    def _get_subscription_cloud_usage_serialize(
        self,
        organisation,
        month,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/subscription/cloud-usage',
