...
class AIAgentsApi:
    ...
    def chat_with_ai_agent(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '202': "ChatWithAIAgent202Response",
            '400': None,
            '403': None,
            '404': None,
            '500': None,
    ...
    @validate_call
    def delete_agent_overlay(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param organisation: The organisation ID (required)
        :type organisation: str
        :param agent_id: Global agent identifier (required)
        :type agent_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_agent_overlay_serialize(
            organisation=organisation,
            agent_id=agent_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteAgentOverlay200Response",
            '403': None,
            '404': None,
            '500': None,
        }
    ...
    @validate_call
    def delete_agent_overlay_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteAgentOverlay200Response]:
        """Delete Agent Overlay
    ...
    @validate_call
    def delete_agent_overlay_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        _request_timeout: Union[
    ...
    def _delete_agent_overlay_serialize(
        self,
        organisation,
        agent_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/organizations/{organisation}/ai/agents/{agentId}/overlay',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_agent_overlay(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier (e.g., 'quantgov-code')")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param organisation: The organisation ID (required)
        :type organisation: str
        :param agent_id: Global agent identifier (e.g., 'quantgov-code') (required)
        :type agent_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_agent_overlay_serialize(
            organisation=organisation,
            agent_id=agent_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAgentOverlay200Response",
            '403': None,
            '404': None,
            '500': None,
        }
    ...
    @validate_call
    def get_agent_overlay_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier (e.g., 'quantgov-code')")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAgentOverlay200Response]:
        """Get Agent Overlay
    ...
    @validate_call
    def get_agent_overlay_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier (e.g., 'quantgov-code')")],
        _request_timeout: Union[
    ...
    def _get_agent_overlay_serialize(
        self,
        organisation,
        agent_id,
        _request_auth,
    ...
    def upsert_agent_overlay(
        ...
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        upsert_agent_overlay_request: UpsertAgentOverlayRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param agent_id: Global agent identifier (required)
        :type agent_id: str
        :param upsert_agent_overlay_request: (required)
        :type upsert_agent_overlay_request: UpsertAgentOverlayRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._upsert_agent_overlay_serialize(
            organisation=organisation,
            agent_id=agent_id,
            upsert_agent_overlay_request=upsert_agent_overlay_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpsertAgentOverlay200Response",
            '400': None,
            '403': None,
            '404': None,
            '409': None,
    ...
    @validate_call
    def upsert_agent_overlay_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        upsert_agent_overlay_request: UpsertAgentOverlayRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpsertAgentOverlay200Response]:
        """Upsert Agent Overlay
    ...
    @validate_call
    def upsert_agent_overlay_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        agent_id: Annotated[StrictStr, Field(description="Global agent identifier")],
        upsert_agent_overlay_request: UpsertAgentOverlayRequest,
    ...
    def _upsert_agent_overlay_serialize(
        self,
        organisation,
        agent_id,
        ...
        # process the form parameters
        # process the body parameter
        if upsert_agent_overlay_request is not None:
            _body_params = upsert_agent_overlay_request
