...
class CommandsApi:
    ...
    def _create_command_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/organizations/{organisation}/environments/{environment}/commands',
    ...
    def get_command(
        ...
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        environment: Annotated[StrictStr, Field(description="The environment ID")],
        command: Annotated[StrictStr, Field(description="The command ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment: The environment ID (required)
        :type environment: str
        :param command: The command ID (required)
        :type command: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_command_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/environments/{environment}/commands/{command}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
