...
class CommandsApi:
    ...
    def create_command(
        ...
        :param create_command_request: (required)
        :type create_command_request: CreateCommandRequest
        ...
        _param = self._create_command_serialize(
            ...
            create_command_request=create_command_request,
    ...
    def _create_command_serialize(
        ...
        if create_command_request is not None:
            _body_params = create_command_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/organizations/{organisation}/applications/{application}/environments/{environment}/commands',
    ...
    def get_command(
        ...
        application: Annotated[StrictStr, Field(description="The application ID")],
        environment: Annotated[StrictStr, Field(description="The environment ID")],
        command: Annotated[StrictStr, Field(description="The command run ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment: The environment ID (required)
        :type environment: str
        :param command: The command run ID (required)
        :type command: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_command_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/applications/{application}/environments/{environment}/commands/{command}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
