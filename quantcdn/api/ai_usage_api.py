...
class AIUsageApi:
    ...
    @validate_call
    def get_my_usage_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMyUsage200Response]:
        """Get AI usage summary for the authenticated user
    ...
    @validate_call
    def get_my_usage_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_my_usage_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/ai/usage/me',
