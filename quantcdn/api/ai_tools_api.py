...
class AIToolsApi:
    ...
    @validate_call
    def get_ai_orchestration_status(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        orchestration_id: Annotated[str, Field(strict=True, description="Orchestration identifier for aggregated async tool executions")],
        ...
        :param orchestration_id: Orchestration identifier for aggregated async tool executions (required)
        ...
        _param = self._get_ai_orchestration_status_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAIOrchestrationStatus200Response",
            '404': "GetAIOrchestrationStatus404Response",
            '403': None,
            '500': None,
        }
    ...
    @validate_call
    def get_ai_orchestration_status_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        orchestration_id: Annotated[str, Field(strict=True, description="Orchestration identifier for aggregated async tool executions")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAIOrchestrationStatus200Response]:
        """Get Tool Orchestration Status (Async Tool Polling)
    ...
    @validate_call
    def get_ai_orchestration_status_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        orchestration_id: Annotated[str, Field(strict=True, description="Orchestration identifier for aggregated async tool executions")],
        _request_timeout: Union[
    ...
    def _get_ai_orchestration_status_serialize(
        self,
        organisation,
        orchestration_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/ai/tools/orchestrations/{orchestrationId}',
    ...
    @validate_call
    def list_mcp_servers_with_http_info(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListMcpServers200Response]:
        """List MCP servers with gateway URLs
    ...
    @validate_call
    def list_mcp_servers_without_preload_content(
        self,
        organisation: Annotated[StrictStr, Field(description="The organisation ID")],
        _request_timeout: Union[
            None,
    ...
    def _list_mcp_servers_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/organizations/{organisation}/ai/mcp-servers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
