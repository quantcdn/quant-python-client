...
with quantcdn.ApiClient(configuration) as api_client:
    ...
    metrics = ['metrics_example'] # List[str] | Metrics to return (default: hits, bytes). Use the /metrics/available endpoint to list all metrics by category. (optional)
 ...
 **metrics** | [**List[str]**](str.md)| Metrics to return (default: hits, bytes). Use the /metrics/available endpoint to list all metrics by category. | [optional] 
