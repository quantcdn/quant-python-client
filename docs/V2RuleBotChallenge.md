...
**action_config** | [**V2RuleBotChallengeAction**](V2RuleBotChallengeAction.md) |  | 
...
json = "{}"
# create an instance of V2RuleBotChallenge from a JSON string
v2_rule_bot_challenge_instance = V2RuleBotChallenge.from_json(json)
# print the JSON string representation of the object
print(V2RuleBotChallenge.to_json())

# convert the object into a dict
v2_rule_bot_challenge_dict = v2_rule_bot_challenge_instance.to_dict()
# create an instance of V2RuleBotChallenge from a dict
v2_rule_bot_challenge_from_dict = V2RuleBotChallenge.from_dict(v2_rule_bot_challenge_dict)
```
