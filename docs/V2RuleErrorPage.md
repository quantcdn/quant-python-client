...
**action_config** | [**V2RuleErrorPageAction**](V2RuleErrorPageAction.md) |  | 
...
json = "{}"
# create an instance of V2RuleErrorPage from a JSON string
v2_rule_error_page_instance = V2RuleErrorPage.from_json(json)
# print the JSON string representation of the object
print(V2RuleErrorPage.to_json())

# convert the object into a dict
v2_rule_error_page_dict = v2_rule_error_page_instance.to_dict()
# create an instance of V2RuleErrorPage from a dict
v2_rule_error_page_from_dict = V2RuleErrorPage.from_dict(v2_rule_error_page_dict)
```
