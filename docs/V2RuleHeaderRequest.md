...
v2_rule_header_request_instance = V2RuleHeaderRequest.from_json(json)
# print the JSON string representation of the object
print(V2RuleHeaderRequest.to_json())

# convert the object into a dict
v2_rule_header_request_dict = v2_rule_header_request_instance.to_dict()
# create an instance of V2RuleHeaderRequest from a dict
v2_rule_header_request_from_dict = V2RuleHeaderRequest.from_dict(v2_rule_header_request_dict)
```
