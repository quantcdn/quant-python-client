...
**action_config** | [**V2RuleProxyAction**](V2RuleProxyAction.md) |  | 
...
json = "{}"
# create an instance of V2RuleProxy from a JSON string
v2_rule_proxy_instance = V2RuleProxy.from_json(json)
# print the JSON string representation of the object
print(V2RuleProxy.to_json())

# convert the object into a dict
v2_rule_proxy_dict = v2_rule_proxy_instance.to_dict()
# create an instance of V2RuleProxy from a dict
v2_rule_proxy_from_dict = V2RuleProxy.from_dict(v2_rule_proxy_dict)
```
