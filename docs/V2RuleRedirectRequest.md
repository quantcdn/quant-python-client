...
**redirect_to** | **str** | Redirect destination URL | 
**redirect_code** | **str** | HTTP status code for redirect | [optional] [default to '301']
...
json = "{}"
# create an instance of V2RuleRedirectRequest from a JSON string
v2_rule_redirect_request_instance = V2RuleRedirectRequest.from_json(json)
# print the JSON string representation of the object
print(V2RuleRedirectRequest.to_json())

# convert the object into a dict
v2_rule_redirect_request_dict = v2_rule_redirect_request_instance.to_dict()
# create an instance of V2RuleRedirectRequest from a dict
v2_rule_redirect_request_from_dict = V2RuleRedirectRequest.from_dict(v2_rule_redirect_request_dict)
```
