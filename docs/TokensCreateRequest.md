...
**preset** | **str** | Preset scope bundle | [optional] 
**scopes** | **List[str]** | Individual scopes (mutually exclusive with preset) | [optional] 
**projects** | **List[int]** | Project IDs to restrict this token to | [optional] 
**expires_in** | **str** | Token expiration period | [optional] 
