...
**action_config** | [**V2RuleCustomResponseAction**](V2RuleCustomResponseAction.md) |  | [optional] 
...
json = "{}"
# create an instance of V2RuleCustomResponse from a JSON string
v2_rule_custom_response_instance = V2RuleCustomResponse.from_json(json)
# print the JSON string representation of the object
print(V2RuleCustomResponse.to_json())

# convert the object into a dict
v2_rule_custom_response_dict = v2_rule_custom_response_instance.to_dict()
# create an instance of V2RuleCustomResponse from a dict
v2_rule_custom_response_from_dict = V2RuleCustomResponse.from_dict(v2_rule_custom_response_dict)
```
